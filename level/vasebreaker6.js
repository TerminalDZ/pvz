...
oS.Init(
	{
		...
		RiddleAutoGrow() {
			...
			while (VaseList.length && GroundList.length) {
				...
				oFlowerVase.prototype.SpecialBirth(Pos[0], Pos[1], Top.Type === "Plants" ? GNum-- > 0 : 0, Top); // Generate vases
		...
		StartGame() {
			...
			oS.RiddleAutoGrow(), f(); // f must be called after generating vases
		},
